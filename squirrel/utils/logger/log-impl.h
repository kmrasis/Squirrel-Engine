...
#define LOG_TRACE(...)                                                                                                                     \
    ...
    {                                                                                                                                      \
        ::Utils::Logger::GetCoreLogger()->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::trace, __VA_ARGS__); \
    }

#define LOG_DEBUG(...)                                                                                                                     \
    if (nullptr != ::Utils::Logger::GetCoreLogger())                                                                                       \
    {                                                                                                                                      \
        ::Utils::Logger::GetCoreLogger()->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::debug, __VA_ARGS__); \
    }

#define LOG_INFO(...)                                                                                                                     \
    if (nullptr != ::Utils::Logger::GetCoreLogger())                                                                                      \
    {                                                                                                                                     \
        ::Utils::Logger::GetCoreLogger()->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::info, __VA_ARGS__); \
    }

#define LOG_WARN(...)                                                                                                                     \
    if (nullptr != ::Utils::Logger::GetCoreLogger())                                                                                      \
    {                                                                                                                                     \
        ::Utils::Logger::GetCoreLogger()->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::warn, __VA_ARGS__); \
    }

#define LOG_ERROR(...)                                                                                                                   \
    if (nullptr != ::Utils::Logger::GetCoreLogger())                                                                                     \
    {                                                                                                                                    \
        ::Utils::Logger::GetCoreLogger()->log(spdlog::source_loc{__FILE__, __LINE__, SPDLOG_FUNCTION}, spdlog::level::err, __VA_ARGS__); \
    }
